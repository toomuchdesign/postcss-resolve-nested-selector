...
test('postcss-nested unwraps rule inside rule', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a', 'a', 'a b', 'a b c']);
});
...
test('postcss-nested cleans rules after unwrap', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a b .one', 'a b .two']);
});
...
test('postcss-nested replaces ampersand', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['body a:hover b']);
});
...
test('postcss-nested replaces ampersands', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a:active', 'a:hover']);
});
...
test('postcss-nested replaces ampersand in string', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['.block_elem']);
});
...
test('postcss-nested unwrap rules inside at-rules', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a b']);
});
...
test('postcss-nested unwraps at-rules', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a', 'a']);
});
...
test('postcss-nested processes comma', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['.one a', '.two a']);
});
...
test('postcss-nested processes comma with ampersand', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['.one:hover', '.two:hover']);
});
...
test('postcss-nested processes comma inside', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), [
    'a .one',
    'a .two',
    'b .one',
    'b .two',
...
test('postcss-nested moves comment with at-rule', async (t) => {
  ...
  t.deepEqual(await util.allExpected(code), ['a']);
});
