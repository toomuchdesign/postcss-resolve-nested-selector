  ...
  return postcss()
    ...
    .then(function (result) {
      ...
      result.root.walk(function (node) {
        ...
        if (
          node.type !== 'atrule' &&
          !nodeContainsDeclChild &&
          nodeContainsBlockDescendant
        )
          return;
        ...
        selectors.forEach(function (selector) {
          resolvedSelectors = resolvedSelectors.concat(
  ...
  return postcss()
    ...
    .then(function (result) {
      ...
      result.root.walk(function (node) {
        ...
        var selectors =
          node.type === 'atrule' ? node.params.split(',') : node.selectors;
